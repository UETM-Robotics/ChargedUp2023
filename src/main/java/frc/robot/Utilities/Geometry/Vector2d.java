 ...
 * @since 0.1
 */
public final class Vector2d implements Interpolable<Vector2d>, Serializable {
	...
	public static Rotation2d getAngleBetween(Vector2d a, Vector2d b) {
		...
		return Rotation2d.fromRadians(Math.acos(MathUtils.clamp(cos, -1.0, 1.0)));
	}
	...
	public boolean equals(Object obj) {
		...
		return equals((Vector2d) obj, MathUtils.EPSILON);
	}

	public boolean equals(Vector2d other, double allowableError) {
