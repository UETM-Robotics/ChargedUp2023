...
public class DifferentialDriveKinematics {
     ...
     */
    public RobotRelativeSpeed toRobotSpeeds(DifferentialDriveWheelSpeeds wheelSpeeds) {
     ...
     */
    public DifferentialDriveWheelSpeeds toWheelSpeeds(RobotRelativeSpeed chassisSpeeds) {
