...
public class SwerveKinematics {
     ...
     * {@link #normalizeModuleVelocities(Vector2d[], double) normalizeModuleVelocities} method to resolve this issue.
     */
    public Vector2d[] toModuleVelocities(ChassisVelocity velocity) {
        ...
        Vector2d[] moduleVelocities = new Vector2d[moduleOffsets.length];

        for (int i = 0; i < moduleOffsets.length; i++) {
            moduleVelocities[i] = new Vector2d(
     ...
     */
    public ChassisVelocity toChassisVelocity(Vector2d... moduleVelocities) {
     ...
     */
    public static void normalizeModuleVelocities(Vector2d[] moduleVelocities, double maximumVelocity) {
