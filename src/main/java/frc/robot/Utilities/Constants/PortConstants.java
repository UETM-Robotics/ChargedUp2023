...
public class PortConstants {
    ...
    //public static final int leftHindDriveMotorPort = 2;
    ...
    public static final int rightFrontDriveMotorPort = 3;
    public static final int rightHindDriveMotorPort = 3;


    public static final int leftFrontThrottleMotorPort = 3, leftFrontAngleMotorPort = 3;
    public static final int leftHindThrottleMotorPort  = 3, leftHindAngleMotorPort  = 3;

    public static final int rightFrontThrottleMotorPort = 3, rightFrontAngleMotorPort = 3;
