...
public class SparkHelper {
    ...
    public static boolean setPIDGains(SparkMaxU spark, int slotID, double kP, double kI, double kD, double kF, double rampRate, double iZone) {
		return setPIDGains(spark, slotID, kP, kI, kD, kF, rampRate, iZone, TechConstants.kTimeoutMs);
	}
    public static boolean setPIDGains(SparkMaxU spark, int slotID, double kP, double kI, double kD, double kF, double rampRate, double iZone, int timeout) {
		boolean setSucceeded = setPIDGains(spark, slotID, kP, kI, kD, kF, timeout);
		int retryCounter = 0;
