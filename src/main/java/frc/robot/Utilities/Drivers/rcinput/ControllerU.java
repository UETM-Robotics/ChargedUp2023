...
public class ControllerU {
	...
	public Vector2d getLeftJoystickVector() {

		return new Vector2d(-getNormalizedAxis(0, TechConstants.kJoystickDeadband),
						    -getNormalizedAxis(1, TechConstants.kJoystickDeadband));
