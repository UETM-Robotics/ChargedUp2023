...
public class RobotState {
    ...
    public synchronized void updateFieldToRobotPose( Pose2d pose ) {
     ...
     mCurrentPose = new Pose2d( pose.x(), pose.y() , pose.getRotation());
    ...
    public synchronized double getFieldRelativeRobotHeading() {
        return mCurrentPose.getRotation().getDegrees();
    }
