...
public class DriveTrain extends Subsystem implements CustomSubsystem {
    ...
    private SparkMaxU leftFront, rightFront;
    private SparkMaxU leftHind , rightHind;
    ...
    /**
     * 
     * @param driveSignal  Percent output to set drive output demand to
     */
    ...
    /**
     * 
     * @param brakeMode Drivetrain brakes when true
     */
    ...
    /**
     * 
     * @param d Percent output to set drive output demand to
     */
    ...
    /**
     * 
     * @param d Velocity in m/s for the drivetrain velocity PIDF
     */
    public synchronized void updatePathVelocitySetpoint(DriveSignal d) {
        ...
        rightFront.set(d.getRight(), ControlType.kVelocity);
        leftFront.set(d.getLeft(), ControlType.kVelocity);
    ...
    public synchronized void updateTurnToHeading(double output) {
